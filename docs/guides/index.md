...
Guides explain how we do things. Any EAR member can propose changes to guides. Changes to the guides section require three members to approve the change. At least one project committee member must review significant changes to guide documents.
